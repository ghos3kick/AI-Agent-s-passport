  ...
  return (
    <div className="trust-score">
      ...
      <div className="trust-breakdown">
        <BreakdownBar label="Existence" value={breakdown.existence} max={20} color={color} />
        <BreakdownBar label="Activity" value={breakdown.activity} max={40} color={color} />
        <BreakdownBar label="Age" value={breakdown.age} max={20} color={color} />
        <BreakdownBar label="Capabilities" value={breakdown.capabilities} max={20} color={color} />
      </div>
    </div>
  );
}
